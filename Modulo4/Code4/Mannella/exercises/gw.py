...
#    surface_xt(lax, f, x, t, lax_param, plot_dim = 0)
    ...
    ###############Just Plot Part###########################################
#    # Temporal evolution
#    f = lax_wendroff(f, dx, dt, N_step, v, s)
#    # Plot results
#    plt.plot(x, f_init[0], label = 'initial')
#    plt.plot(x, f[0], label = 'final')
#    plt.legend()
#    plt.show()
    ...
    #                                   # (Withou f)
    # Animated + sliders
    aniplt.animated_with_slider(lax_wendroff, f, x, t, lax_param, plot_dim = 0)
    # Surface plots
    #surface_xt(lax_wendroff, f, x, t, lax_param, plot_dim = 0)
    return 
