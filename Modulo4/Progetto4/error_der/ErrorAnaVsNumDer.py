...
for N in NN:
	...
	list_dx.append(dx)
    # simm der order 4
	f_num = der.simm_der_Ord4(u(x), dx)
	list_err1_s_ord4.append(err1(f_ana, f_num))
...
ax.plot(list_N, list_err1_s_ord4, marker = '.', label = 'simm ord4', lw = 0.6) #error of order dx**2
ax.plot(list_N, list_err1_fft, marker = '.', label = 'fft', lw = 0.6) #error of order very low
ax.plot(list_N, list_err1_dfc, marker = '.', label = 'diff fin comp', lw = 0.6) #error of order dx**4
